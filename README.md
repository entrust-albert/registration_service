...
**Note:** It is really important to add this specific volume (`-v /var/run/docker.sock:/var/run/docker.sock jenkins/jenkins:lts`) when running the docker or it won't have the right permissions. 
